<template>
  <div class="container mx-auto px-4 mt-4">
    <div>
      ...
      <h2 class="sm:text-3xl font-semibold mb-8">
        Leiklistarnámskeið fyrir börn og fullorðna saman
      </h2>
      ...
      <div>
        ...
        <p>Viltu rifja upp hvernig var að leika sér?</p>
        <p>Viltu losna við stífni og hömlur og óttann við að koma fram?</p>
        <p>Viltu skemmta þér með barninu þínu?</p>

        <p>Ef svarið er já: Búum til leikrit!</p>

        <p>Ég heiti Hrund Ólafsdóttir. Ég hef verið leiklistarkennari og íslensku- ensku og bókmenntakennari. Ég skrifa leikrit og leikstýri og svo hef ég leikið heilmikið.</p>
